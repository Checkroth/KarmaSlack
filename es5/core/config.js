...
var Config = (function () {
	function Config() {
		...
		this._mongodbPort = '25762';
	}

	_createClass(Config, [{
		key: 'db',
		get: function get() {
			return this.productionEnv ? 'mongodb://' + this._mongodbUsername + ':' + this._mongodbPassword + '@' + this._mongodbEndpoint + ':25762/' + this._mongodbName : 'mongodb://localhost/karma';
		}
	}, {
		key: 'port',
		get: function get() {
